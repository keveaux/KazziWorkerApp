...
public class loginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        termsandconditions=view.findViewById(R.id.termsandconditionstxt);
        ...
        termsandconditions.setTypeface(font);
        pinView.setTypeface(font);
        mcontinue.setTypeface(font);
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            case STATE_INITIALIZED:
                ...
                enableViews(pinView, phonenumber);
                disableViews(mcontinue, didnotgetcode);
                entercode.setText("enter code that was sent to");
                break;
            case STATE_CODE_SENT:
                // Code sent state, show the verification field, the
                enableViews(mcontinue, didnotgetcode, phonenumber, pinView);
                //disableViews(mStartButton);
                entercode.setText(R.string.status_code_sent);
                break;
            case STATE_VERIFY_FAILED:
                // Verification has failed, show all options
                enableViews(pinView, mcontinue,didnotgetcode, phonenumber
                );
                entercode.setText(R.string.status_verification_failed);
                progressBar.setVisibility(View.INVISIBLE);
                break;
            case STATE_VERIFY_SUCCESS:
                // Verification has succeeded, proceed to firebase sign in
                disableViews(pinView, mcontinue, didnotgetcode, phonenumber
                );
                entercode.setText("Verfication Sucessfull");
                progressBar.setVisibility(View.INVISIBLE);

                // Set the verification text based on the credential
                if (cred != null) {
                    if (cred.getSmsCode() != null) {
                        pinView.setText(cred.getSmsCode());
                    } else {
                        pinView.setText(R.string.instant_validation);
                    }
                }
            ...
            case STATE_SIGNIN_FAILED:
                ...
                entercode.setText(R.string.status_sign_in_failed);
                progressBar.setVisibility(View.INVISIBLE);
                break;
